export default {
  ...
  auth: {
    ...
    signup: {
      ...
      currencyLocked:
        "Ce choix est définitif : la devise ne pourra plus être modifiée ensuite.",
      password: "Mot de passe",
      passwordPlaceholder: "••••••••",
      emailPlaceholder: "vous@exemple.com",
  ...
  profile: {
    ...
    currencyHint:
      "Ce choix est définitif : la devise ne pourra plus être modifiée ensuite.",
    currencyConfirmTitle: "Confirmer la devise",
    currencyConfirmMessage:
      "Vous allez définir {{currency}} comme devise de votre boutique. Ce choix est définitif et ne pourra plus être changé. Continuer ?",
  ...
  billing: {
    ...
    paymentInvoicesSubtitle:
      "Modifier la carte, voir l'historique des factures",
    plans: {
      starter: "Starter",
      business: "Business",
      premium: "Premium",
  ...
  share: {
    ...
    completeProfileFirst:
      "Veuillez d'abord compléter le profil de votre boutique.",
  ...
  orders: {
    ...
    whatsappMessage:
      "Bonjour {{name}}, ceci concerne votre commande #{{orderId}}.",
  ...
  products: {
    ...
    currencyRequiredTitle: "Devise non définie",
    currencyRequiredMessage:
      "Définissez la devise de votre boutique dans votre profil avant d'ajouter des produits. Ce choix sera définitif.",
  ...
  shop: {
    ...
    unavailableBody:
      "Cette boutique est temporairement indisponible. Veuillez contacter le commerçant.",
    ...
    orderThanks:
      "Merci. Votre commande chez {{shopName}} a été soumise avec succès.",
    orderContact:
      "Le commerçant vous contactera pour le paiement et la livraison.",
